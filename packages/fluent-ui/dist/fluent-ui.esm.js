import { CommandBarButton, TextField, Text, MessageBar, MessageBarType, IconButton, List, PrimaryButton, Label, Checkbox, ColorPicker, getColorFromString, DatePicker, DayOfWeek, mergeStyleSets, ChoiceGroup, Slider, Dropdown, SpinButton, initializeIcons } from '@fluentui/react';
import { withTheme } from '@rjsf/core';
import React from 'react';
import { getUiOptions, getTemplate, getInputProps, ariaDescribedByIds, examplesId, errorId, helpId, titleId, descriptionId, getSubmitButtonOptions, enumOptionsIsSelected, optionId, enumOptionsSelectValue, enumOptionsDeselectValue, enumOptionsValueForIndex, pad, utcToLocal, localToUTC, enumOptionsIndexForValue, rangeSpec } from '@rjsf/utils';
...
function ArrayFieldTemplate(props) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(ArrayFieldTitleTemplate, {
    idSchema: idSchema,
  ...
  }), canAdd && React.createElement("span", {
    style: rightJustify
...
function MoveDownButton(props) {
  return React.createElement(FluentIconButton, _extends({
    title: "Move down"
  }, props, {
    icon: "Down"
  }));
...
function FieldTemplate(props) {
  ...
  return React.createElement(WrapIfAdditionalTemplate, _extends({}, props), React.createElement("div", {
    id: id,
  ...
  }, children, rawDescription && React.createElement(Text, null, rawDescription), errors, help));
}
...
function CheckboxWidget(props) {
  ...
  var _onChange = React.useCallback(function (_, checked) {
    onChange(checked);
  }, [onChange]);
...
function ColorWidget(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Label, null, label || schema.title, required && React.createElement("span", {
    style: styles_red$1
  }, "\xA0*")), React.createElement(ColorPicker, _extends({
...
function RadioWidget(_ref) {
  ...
  return React.createElement(ChoiceGroup, _extends({
    id: id,
    name: id,
    options: newOptions,
    disabled: disabled || readonly,
...
function RangeWidget(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Label, null, label || schema.title, required && React.createElement("span", {
    style: styles_red
  }, "\xA0*")), React.createElement(Slider, _extends({
    disabled: disabled || readonly,
    min: sliderProps.min,
    max: sliderProps.max,
...
function SelectWidget(_ref) {
  ...
  var _onBlur = function _onBlur(e) {
    return onBlur(id, enumOptionsValueForIndex(e.target.value, enumOptions, emptyValue));
  };
  var _onFocus = function _onFocus(e) {
    return onFocus(id, enumOptionsValueForIndex(e.target.value, enumOptions, emptyValue));
  };
  var newOptions = Array.isArray(enumOptions) ? enumOptions.map(function (option, index) {
    return {
      key: String(index),
...
function UpDownWidget(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Label, {
    htmlFor: id
  }, label + requiredSymbol), React.createElement(SpinButton, _extends({
    id: id,
    min: min,
    max: max,
    step: step,
...
export { FuiForm as Form, Templates, Theme, Widgets, FuiForm as default, generateForm, generateTemplates, generateTheme, generateWidgets };
